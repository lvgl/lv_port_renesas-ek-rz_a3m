...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_01_PIN_00,
		...
		| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_CFG_SLEW_RATE_FAST
		| (uint32_t) IOPORT_PERIPHERAL_MODE1) }, { .pin = BSP_IO_PORT_22_PIN_00,
		.pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B10
				| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
				| (uint32_t) IOPORT_CFG_SLEW_RATE_FAST
				| (uint32_t) IOPORT_PERIPHERAL_MODE1) }, { .pin =
		BSP_IO_PORT_22_PIN_01, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B10
		| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_CFG_SLEW_RATE_FAST
		| (uint32_t) IOPORT_PERIPHERAL_MODE1) }, { .pin = BSP_IO_PORT_22_PIN_02,
		.pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B10
				| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
				| (uint32_t) IOPORT_CFG_SLEW_RATE_FAST
				| (uint32_t) IOPORT_PERIPHERAL_MODE1) }, { .pin =
		BSP_IO_PORT_22_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B10
		| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_CFG_SLEW_RATE_FAST
		| (uint32_t) IOPORT_PERIPHERAL_MODE1) }, { .pin = BSP_IO_PORT_22_PIN_04,
		.pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B10
				| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
				| (uint32_t) IOPORT_CFG_SLEW_RATE_FAST
				| (uint32_t) IOPORT_PERIPHERAL_MODE1) }, { .pin =
